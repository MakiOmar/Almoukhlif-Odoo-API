...
class Odoo_Hooks {
    ...
    public static function init() {
        ...
        // Order hooks
        add_action('woocommerce_checkout_order_created', array(__CLASS__, 'on_order_created'), 9999, 1);
        add_action('woocommerce_process_shop_order_meta', array(__CLASS__, 'on_order_updated'), 9999, 1);
